...
ssh 192.168.1.99 'mkdir /home/pi/localfs;sudo mount -ouid=1001,gid=1001 -o umask=0000 -o allow_other /dev/sda1  /home/pi/localfs;sudo apt-get install exfat-fuse exfat-utils;sudo apt install nfs-kernel-server;sudo rm /etc/exports;sudo mv ./exports /etc/exports;sudo exportfs -r;sudo exportfs;echo "/dev/sda1  /home/pi/localfs   exfat-fuse rw 0 0" >>sudo /etc/fstab'
...
sudo umount ~/localfs
sudo mount -ouid=1001,gid=1001 -o umask=0000 -o allow_other 192.168.1.99:/home/pi/localfs ~/localfs
